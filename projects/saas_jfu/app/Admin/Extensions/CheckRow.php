...
SCRIPT;
    ...
    protected function render()
    {
        ...
        Admin::script($this->zpJs());

        Admin::js('/static/zipeijs/qnviccub.js');
        Admin::js('/static/zipeijs/qnvfunc.js');
        Admin::js('/static/zipeijs/json2.js');
        Admin::js('/static/zipeijs/deviceapi.js');

        $html = '<textarea id="StatusArea" rows="3" name="S1" cols="86"></textarea>
<input type="button" value="检查本地驱动是否安装" name="B0" onClick="I_CheckActiveX()"></p>
<p><input type="button" value="打开设备" name="B3" onClick="OpenDevice(ODT_LBRIDGE,function(nResult){AppendStatus(\'打开设备.\');});">
<input type="button" value="关闭设备" name="B6" onClick="CloseDevice(ODT_LBRIDGE,function(nResult){AppendStatus(\'关闭设备.\');});">&nbsp;&nbsp;&nbsp;
<form>
<p>
...
<form>';
        return $html."<a class='btn btn-xs btn-success callmobile' data-id='{$this->mobile}'><i class=\"fa fa-phone\" aria-hidden=\"true\"></i>拨号</a>
<a class='btn btn-xs btn-primary' data-id='{$this->mobile}'>挂机</a>";
